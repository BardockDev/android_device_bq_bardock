...
TARGET_KERNEL_CONFIG := bardock-pro_defconfig
TARGET_KERNEL_SOURCE := kernel/bq/bardock
...
# Init
TARGET_INIT_VENDOR_LIB := libinit_bardock
TARGET_PLATFORM_DEVICE_BASE := /devices/soc/
TARGET_RECOVERY_DEVICE_MODULES := libinit_bardock
